        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/projects" className="text-sm text-background/80 hover:text-primary transition-colors">
                  Projects
                </Link>
              </li>
              <li>
                <Link to="/quality-checklist" className="text-sm text-background/80 hover:text-primary transition-colors">
                  Quality Checklist
                </Link>
              </li>
              <li>
                <Link to="/careers" className="text-sm text-background/80 hover:text-primary transition-colors">
                  Careers
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-sm text-background/80">Turnkey House Construction</li>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <div className="text-sm text-background/80">
                  <a href="tel:6374507535" className="hover:text-primary transition-colors">
                    63745 07535
                  </a>
                  <br />
                  <a href="tel:7538880504" className="hover:text-primary transition-colors">
                    75388 80504
                  </a>
                </div>
              </li>
              ...
              <li className="flex items-start gap-2">
                <Instagram className="w-4 h-4 mt-1 text-primary flex-shrink-0" />
                <a
